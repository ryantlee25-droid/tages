...
const VALUES = [
  ...
  },
  {
    ...
    description: 'Agents scored 8.8/10 with Tages vs 7.7/10 without in blind A/B testing. Convention compliance improved by 3 points.',
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: 'Self-hostable, MIT licensed',
    description: 'Bring your own Supabase. No data leaves your infrastructure. Open source and free forever for self-hosted deployments.',
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
