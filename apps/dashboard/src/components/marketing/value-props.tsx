...
const VALUES = [
  ...
  },
  {
    ...
    description: 'Your agents follow the same naming patterns, error handling, and architecture decisions every time. No more re-explaining your codebase standards each session.',
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'SQLite cache means your agent never waits. Works fully offline. Supabase syncs in the background when connected, so memories follow you across machines.',
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
